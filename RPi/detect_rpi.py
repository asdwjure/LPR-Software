...
if __name__ == '__main__':
    ...
    lpr = LicensePlateRecognition(PATH_TO_MODEL, capture_source='/home/jrebernik/Magistrska/LPR-Software/dataset/collected_images/test_video.avi', params=params, debug_level=1)

    # Start license plate image processing in a separate process
    p = multiprocessing.Process(target = image_processing, args=())
    p.start()
    p.join()
