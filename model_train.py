###################################################################################################
# Title: Model trainer
# Description: Run tensorflow object detection API script to train model
# 
...
if __name__ == '__main__':
    ...
    cmd = "python {} --model_dir={} --pipeline_config_path={} --num_train_steps={}".format(TRAINING_SCRIPT, paths['CHECKPOINT_PATH'],files['PIPELINE_CONFIG'], args.num_steps)
